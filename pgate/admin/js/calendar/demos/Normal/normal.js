...
var gcCalBG="#DCE1E4";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#DCE1E4";	// the background color of the inner table, showing as a frame.
...
var gcSatBG="#DCE1E4";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#DCE1E4";	// Sunday background color
