...
var gBegin=gToday; //[1930,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gsTodayTip="Close";	// tooltip for today
